...
<p align="center">
  <img src="figures/X(pi).png" width="50%" alt="Transformer X(pi)">
  <img src="figures/SCORE_4_X(pi).png" width="50%" alt="SCORE X(pi)">
  <img src="figures/X(pi-2).png" width="50%" alt="Transformer X(pi-2)">
  <img src="figures/SCORE_4_X(pi-2).png" width="50%" alt="SCORE X(pi-2)">
  <br>
  <img src="figures/Hadamard.png" width="50%" alt="Transformer Hadamard">
  <img src="figures/SCORE_4_Hadamard.png" width="50%" alt="SCORE Hadamard">
  <img src="figures/Z(pi-4).png" width="50%" alt="Transformer Z(pi-4)">
  <img src="figures/SCORE_4_Z(pi-4).png" width="50%" alt="SCORE Z(pi-4)">
</p>
